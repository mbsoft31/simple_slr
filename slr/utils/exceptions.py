...
class ProviderNotFoundError(ProviderError):
    ...
    def __init__(self, provider: str, message: str = "Provider not found", **kwargs):
...
class ProviderConfigError(ProviderError):
    ...
    def __init__(self, provider: str, message: str = "Invalid configuration", **kwargs):
...
class DeduplicationError(SLRException):
    ...
    def __init__(self, message: str = "Deduplication failed", **kwargs):
...
class ExportError(SLRException):
    ...
    def __init__(self, message: str = "Export failed", format: Optional[str] = None, **kwargs):
...
class QueryError(SLRException):
    ...
    def __init__(self, message: str = "Query error", query: Optional[str] = None, **kwargs):
